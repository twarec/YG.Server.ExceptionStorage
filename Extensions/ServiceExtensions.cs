...
{
    public static IServiceCollection AddExceptionsStorage(this IServiceCollection services, string dataBase)
    {
    ...
    {
        options.SwaggerEndpoint(url: $"www/swagger/ExceptionStorage/swagger.json", name: "ExceptionStorage");
        return options;
    }
